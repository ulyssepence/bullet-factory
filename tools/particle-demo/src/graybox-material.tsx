...
const styleConfigs: Record<SurfaceStyle, {
  ...
  rough: {
    ...
    fragmentCode: /* glsl */ `
      ...
      float n = ng.w;
      vec3 grad = ng.xyz;
      surfaceColor = baseColor * (0.85 + 0.15 * n);
      bumpGrad = grad;
      roughnessMod = 0.05 * n;
    `,
  },
  ...
  organic: {
    ...
    fragmentCode: /* glsl */ `
      ...
      float warp = snoise(triUV * noiseScale * 0.5) * 0.5;
      vec3 warped = triUV * noiseScale + vec3(warp);
      vec4 ng = fbm_grad(warped, 2);
      float n = ng.w;
      surfaceColor = baseColor * (0.8 + 0.2 * n);
      bumpGrad = ng.xyz;
      roughnessMod = 0.1 * n;
    `,
  },
  crystalline: {
    ...
    fragmentCode: /* glsl */ `
      ...
      surfaceColor = baseColor * (0.7 + 0.3 * n);
  ...
  worn: {
    ...
    fragmentCode: /* glsl */ `
      ...
      surfaceColor = baseColor * (0.7 + 0.3 * wear);
      bumpGrad = ng.xyz;
      roughnessMod = 0.2 * wear;
