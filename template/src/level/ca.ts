...
export const DEMO_CONFIG: ArenaConfig = {
  ...
  zones: [
    { density: 0.56, hue: 200, motifs: [MOTIF_CHOKEPOINT], smoothingPasses: 0 },
    { density: 0.62, hue: 120, motifs: [MOTIF_CLEARING], smoothingPasses: 2 },
    { density: 0.50, hue: 40,  motifs: [MOTIF_COVER], smoothingPasses: 1 },
  ],
  boundaries: [],
  corridors: [
    { from: 0, to: 1 },
